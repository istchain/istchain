...
import (
	...
	"github.com/istchain/istchain/cmd/istchain/cmd/iavlviewer"
	"github.com/istchain/istchain/cmd/istchain/cmd/rocksdb"
)

// EnvPrefix is the prefix environment variables must have to configure the app.
const EnvPrefix = "ISTCHAIN"

// NewRootCmd creates a new root command for the istchain blockchain.
func NewRootCmd() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		Use:   "istchain",
		Short: "Daemon and CLI for the IstChain blockchain.",
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			customAppTemplate, customAppConfig := servercfg.AppConfig("uist")
...
// addSubCmds registers all the sub commands used by istchain.
