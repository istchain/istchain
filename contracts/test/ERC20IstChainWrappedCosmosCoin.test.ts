...
import {
  ...
  ERC20IstChainWrappedCosmosCoin__factory as ERC20IstChainWrappedCosmosCoinFactory,
} from "../typechain-types";

const decimals = 6n;

describe("ERC20IstChainWrappedCosmosCoin", function () {
  let erc20: ERC20IstChainWrappedCosmosCoin;
  let erc20Factory: ERC20IstChainWrappedCosmosCoinFactory;
  let owner: Signer;
  let sender: Signer;
